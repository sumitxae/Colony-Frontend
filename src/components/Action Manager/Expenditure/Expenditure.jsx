...
const Expenditure = ({ isOpen, setIsOpen, teams, team, type, setParentOpen }) => {
    ...
    >
      ...
      <div className="bg-[#18181B] w-11/12 rounded-lg overflow-hidden shadow-xl max-w-xl h-auto lg:w-full relative z-10 p-6">
        ...
        <FormControl fullWidth className="my-4">
          ...
          >
            Available Funds: {`${form.from._id ? form.from.funds : colony.funds} ${currency}`}
          </Typography>
        </FormControl>
